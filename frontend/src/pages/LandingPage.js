...
const LaunchPad = ({ recordingBlob, inputRef }) => {
    ...
    return (
        <div className="w-full max-w-3xl mx-auto flex flex-col flex-1" data-testid="landing-tryit">
            <p className="text-[11px] text-white/30 mb-6" data-testid="landing-no-account">
            ...
            <div className="mt-8 pt-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-t border-white/10">
...
const LandingPage = () => {
    ...
    return (
        <div className="landing-page landing-tool min-h-screen text-white flex flex-col" style={{ background: '#050807' }} data-testid="landing-page">
            <header className="relative z-20 shrink-0" data-testid="landing-toolbar">
            ...
            <main className="relative z-10 flex-1 flex flex-col px-4 sm:px-6 py-8 sm:py-12">
                <LaunchPad recordingBlob={recordingBlob} inputRef={inputRef} />
            </main>
